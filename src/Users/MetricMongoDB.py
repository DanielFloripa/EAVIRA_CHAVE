...
k_values = ['energy_mon_total', 'max_host_on_i', 'total_energy_f', 'sla_violations_i', 'elapsed_time_i', 'accept_i',
            'reject_i', 'migration_i', 'consolidation_i', 'replication_i', 'overcommit_i', 'placement_i']
...
class MetricsDB(object):
    ...
    def init_dict(self, is_print=False):
        ...
        for az_id in temp_az_list:
            self.__metrics_dict[az_id] = self.client[az_id]
