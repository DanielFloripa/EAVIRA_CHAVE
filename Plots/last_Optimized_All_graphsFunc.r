...
#install.packages(c("rjson", "RColorBrewer", "rlist")) # "reshape2", "ggplot2", ))
...
fn <- list(
    "lf_fff", "lr_fff", "lt_fff","xf_fff", "xr_fff", "xt_fff","nf_fff", "nr_fff", "nt_fff",
    "lf_fft", "lr_fft", "lt_fft","xf_fft", "xr_fft", "xt_fft","nf_fft", "nr_fft", "nt_fft",
    "lf_ftf", "lr_ftf", "lt_ftf","xf_ftf", "xr_ftf", "xt_ftf","nf_ftf", "nr_ftf", "nt_ftf",
    "lf_ftt", "lr_ftt", "lt_ftt","xf_ftt", "xr_ftt", "xt_ftt","nf_ftt", "nr_ftt", "nt_ftt",
    "lf_tff", "lr_tff", "lt_tff","xf_tff", "xr_tff", "xt_tff","nf_tff", "nr_tff", "nt_tff",
    "lf_tft", "lr_tft", "lt_tft","xf_tft", "xr_tft", "xt_tft","nf_tft", "nr_tft", "nt_tft",
    "lf_ttf", "lr_ttf", "lt_ttf","xf_ttf", "xr_ttf", "xt_ttf","nf_ttf", "nr_ttf", "nt_ttf",
    "lf_ttt", "lr_ttt", "lt_ttt","xf_ttt", "xr_ttt", "xt_ttt","nf_ttt", "nr_ttt", "nt_ttt")
...
error=function(cond){
    message("ERROR on change_dir:")
    message(root)
},
warning=function(cond){
    message("WARNING on change_dir:")
    message(root)
},
finnaly={
...
plotAll000<-function(files, legen, azid_list, metrics_b, metrics_l){
    ...
    for(az in azid_list){
        ...
        for(m_l in metrics_l){
            ...
            par(new = TRUE)
            plot(ttt, type="l", lwd=1, col=colors[9], lty=9, pch=9, axes = FALSE, xlab="", ylab="" )
            par(new = TRUE)
